...
public class VariableRun {
	...
	public static void main(String[] args) {
		...
		//		실수형인 float 자료형에 담을 수 있는 값의 범위가 더 크기 때문에 자동 형변환이 일어남
		...
		// char 의 경우 음수값 저장 가능? X . 가지고 있는 수의 범위가 0 ~ 65535.
		// char c2 = -10; (X)
		char c2 = 62623;
		System.out.println("c2 : "+c2);
		
		System.out.println((int)'김'+" "+(int)'정'+" "+(int)'현');
